...
def test_import():
    ...
    '''
    try:
        bank_data = cls.import_data(CSV_FILE)
...
def test_encoder_helper():
    ...
    try:
        for column in categorical_cols:
            assert bank_data[f"{column}_Churn"] is not None
...
def test_train_models():
    ...
    try:
        ...
        assert ['classification_report_lr.png', 'classification_report_rf.png', 'feature_importance_plot.png', 'roc.png'] == results_images
    except AssertionError as err:
